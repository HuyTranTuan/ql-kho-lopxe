...
<h3 class="mb-4 text-center">Thêm mới khách hàng</h3>
<c:url value="/admin/khach-hang/add" var="url"/>
	...
	<div class="row">
		<div class="col-md-6 m-auto">
			...
			<div class="form-group">
				...
				<a class="btn btn-secondary" href='<c:url value="/admin/khach-hang"/>'>Quay lại</a>
			</div>
		</div>
	</div>
</mvc:form>