...
<h3 class="mb-4 text-center">Thêm mới nhập kho</h3>

<c:url value="/admin/nhap-kho/add" var="url"/>
<mvc:form method="post" action="${ url }" modelAttribute="receiving">
	<div class="row">
		<div class="col-md-6 m-auto">
			<div class="form-group">
				<label>Nhà cung cấp</label> <mvc:input type="text" path="customer"
					cssClass="form-control" placeholder="supplier" />
			...
			<div class="form-group">
				...
				<a class="btn btn-secondary" href='<c:url value="/admin/nhap-kho"/>'>Quay lại</a>
			</div>
		</div>
	</div>
</mvc:form>